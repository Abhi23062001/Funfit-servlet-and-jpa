...
@WebServlet("/modifyCurrentParticipant")
public class ModifyParticipant extends HttpServlet {
    @Override
...
//        System.out.println(participant);
        ParticipantService.getParticipantService().updateParticipant(participant);
