...
<body>
<div class="container">
<h2 class="display-3 mb-2">Create Participant</h2>
<hr class="mb-4">
<form action="/createNewParticipant" method="POST">
    <input name="id" type="hidden" value="0">
    <input name="name" placeholder="Enter name" class="form-control w-25 mb-3" type="text" required>
    <input name="age" placeholder="Enter age" class="form-control w-25 mb-3" type="number" required>
